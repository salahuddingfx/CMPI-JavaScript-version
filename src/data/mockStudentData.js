...
export function getEmailsForUser(userEmail) {
  const allEmails = [
    // Emails TO rahim.cst@cmpi.edu.bd
    {
      id: "r1",
      from: "exam@cmpi.edu.bd",
      to: "rahim.cst@cmpi.edu.bd",
      subject: "Mid-term examination routine published",
      preview: "The mid-term exam routine is now available.",
      body: "Dear Rahim Miah,\n\nThe mid-term examination routine for 4th semester CST department has been published. Please check the Notice Board for details.\n\nBest regards,\nExam Controller",
      date: "2026-06-18",
      folder: "inbox",
      read: false,
      starred: true,
    ...
    {
      id: "r3",
      from: "tanjila.cst@cmpi.edu.bd",
      to: "rahim.cst@cmpi.edu.bd",
      subject: "Web Development assignment deadline",
      preview: "The deadline for the web dev project has been...",
    ...
    {
      id: "r4",
      from: "lab@cmpi.edu.bd",
      to: "rahim.cst@cmpi.edu.bd",
      subject: "Database lab assignment 3",
      preview: "Complete SQL exercises for the database lab...",
    ...
    {
      id: "r5",
      from: "rahim.cst@cmpi.edu.bd",
      to: "tanjila.cst@cmpi.edu.bd",
      subject: "Project submission - React app",
      preview: "I have completed the web development project...",
    ...
    },
    {
      id: "r7",
      from: "rahim.cst@cmpi.edu.bd",
      to: "fatima.civil@cmpi.edu.bd",
      subject: "Project collaboration",
      preview: "Hi Fatima, would you like to collaborate on...",
    ...
    {
      id: "f1",
      from: "nasrin.civil@cmpi.edu.bd",
      to: "fatima.civil@cmpi.edu.bd",
      subject: "Surveying field work schedule",
      preview: "The surveying field work has been scheduled...",
    ...
    {
      id: "f4",
      from: "fatima.civil@cmpi.edu.bd",
      to: "rahim.cst@cmpi.edu.bd",
      subject: "Re: Project collaboration",
      preview: "Hi Rahim, sure I would love to collaborate...",
    ...
    {
      id: "a1",
      from: "mizan.electrical@cmpi.edu.bd",
      to: "arif.eee@cmpi.edu.bd",
      subject: "Power electronics lab report",
      preview: "Submit your lab report on thyristor circuits...",
    ...
    // Shared institute emails
    {
      id: "i1",
      from: "exam@cmpi.edu.bd",
      to: "all-students@cmpi.edu.bd",
      subject: "Result publication - 3rd semester",
      preview: "3rd semester results have been published.",
