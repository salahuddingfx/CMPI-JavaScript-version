...
export function Syllabus() {
  ...
  const handleRemovePdf = (dept, sem) => {
    const key = `${dept}-${sem}`;
  ...
  const depts = Object.keys(deptLabel);
              ...
              return (
                <div key={sem} className="rounded-2xl border border-slate-200 bg-card shadow-xl overflow-hidden backdrop-blur-md">
                  ...
                  <div className="flex items-center justify-between bg-primary px-6 py-4 border-b">
                    <div>
                      <span className="text-xs uppercase font-extrabold tracking-wider text-white/70">Academic Structure</span>
                    ...
                    <div className="p-5 flex-1 min-w-0">
                      {hasDbData ? (
                        ...
                        <div>
                          ...
                          <ul className="divide-y space-y-0 font-semibold">
                            {mockSemData?.courses?.map((c, ci) => (
                              <li key={c} className="flex items-center gap-3 py-2.5 text-sm font-semibold text-slate-800">
                      ...
                      {pdfUrl ? (
                        ...
                        <>
                          ...
                          {isAdmin ? (
                            ...
                            <p className="text-[11px] text-center text-slate-500 italic font-medium px-2">
