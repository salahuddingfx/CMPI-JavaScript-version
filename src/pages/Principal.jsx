...
export function Principal() {
  ...
  useEffect(() => {
    ...
    api.get("/admin-messages")
      ...
      .catch((err) => console.error("Failed to load administration messages", err))
      .finally(() => {
  ...
  return (
    <PageTransition>
      <SEO
        ...
        description="Read inspirational messages from our Founder, Governing Body, and the Principal of CMPI."
      />
