  ...
  return (
    <PageTransition>
      <SEO
        ...
        description="Message from the Principal of Cox's Bazar Model Polytechnic Institute."
      />
      <section className="container section-pad">
        <SectionHeader
          eyebrow="Administration"
          title="Principal's Message"
          description="A message from the office of the Principal."
          align="center"
          className="mb-10"
        />
        ...
        <div className="mx-auto max-w-2xl">
          <div className="rounded-sm border bg-card p-8 shadow-sm">
            ...
            <blockquote className="mt-6 border-l-4 border-primary/30 pl-4 text-sm italic leading-relaxed text-muted-foreground">
              ...
              <br />
              <br />
              Cox's Bazar Model Polytechnic Institute has been a beacon of
              technical education in the Chittagong Hill Tracts region. Our
              mission is to produce skilled technologists who can contribute to
              the nation's development.
              <br />
              <br />
              We offer three diploma programs — Computer Science & Technology,
              Civil Technology, and Electrical Technology — each designed with a
              blend of theoretical knowledge and practical skills.
              <br />
              <br />
              Our dedicated faculty, modern laboratories, and industry
              partnerships ensure our students are well-prepared for the
              challenges of the modern workforce. I encourage all students to
