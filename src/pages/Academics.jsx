        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {departments.map((dept) => {
              ...
              return (
                <div key={dept.id} className="group border border-slate-100 dark:border-slate-800 rounded-2xl overflow-hidden hover:shadow-2xl transition-all duration-300 flex flex-col h-full">
                  <div className="h-56 overflow-hidden relative bg-slate-100 dark:bg-slate-800">
                    ...
                    <div className="absolute top-4 left-4 bg-white dark:bg-slate-800 p-3 rounded-lg shadow-md text-primary">
                      <Icon className="w-6 h-6" />
                    </div>
                  </div>
                  <div className="p-8 flex flex-col flex-grow">
                    <h2 className="text-2xl font-bold mb-4 text-slate-900 dark:text-white group-hover:text-primary transition-colors">{dept.name}</h2>
                    ...
                    <div className="flex flex-wrap gap-4 mb-8 mt-auto">
                      <div className="flex items-center gap-2 text-xs font-semibold text-gray-500 dark:text-slate-400 bg-gray-50 dark:bg-slate-800 px-3 py-1 rounded-full border border-slate-200 dark:border-slate-700">
      ...
      <section className="py-20 bg-slate-50 dark:bg-slate-900">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">Why Choose Technical Education at CMPI?</h2>
            <p className="text-gray-600 dark:text-slate-400">We don't just teach theory; we prepare you for the real world.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="bg-white dark:bg-slate-950 p-8 rounded-xl shadow-sm border border-slate-100 dark:border-slate-800">
