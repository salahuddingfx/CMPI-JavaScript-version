    ...
    <PageTransition>
      ...
      <section className="bg-primary text-white">
        <div className="container py-12 sm:py-16">
          ...
          >
            <Link to="/clubs">
              <ArrowLeft className="mr-2 h-4 w-4" /> All Clubs
            </Link>
          </Button>
          ...
          <div className="flex flex-col sm:flex-row gap-6 items-start">
            ...
            <div>
              <p className="text-sm font-bold uppercase tracking-widest text-white/60 mb-1">
                Student Club
              </p>
              <h1 className="text-4xl font-black text-white">{club.name}</h1>
              <p className="mt-2 text-lg text-white/80 italic">
                {club.tagline}
              </p>
              <div className="mt-4 flex flex-wrap gap-4 text-sm text-white/70">
                ...
                <span className="flex items-center gap-1.5">
                  <Calendar className="h-4 w-4" /> Est. {club.founded}
                </span>
                <a
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-sm border bg-card p-6 shadow-sm text-center">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Interested in joining? Send an email to the club president.
              </p>
              <a
                href={`mailto:${club.contact}?subject=Join Request — ${club.name}`}
              >
