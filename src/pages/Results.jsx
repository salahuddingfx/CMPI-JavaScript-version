...
export function Results() {
  ...
  const [btebSearchType, setBtebSearchType] = useState("roll");
  ...
  const [calculatorGpas, setCalculatorGpas] = useState(Array(8).fill(""));
  const [calculatorReg, setCalculatorReg] = useState("2022");
  ...
  const handleAutoPopulateCalculator = (results, inferredReg) => {
