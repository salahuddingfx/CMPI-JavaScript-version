...
function getStoredUser() {
  ...
  const raw = localStorage.getItem("cmpi_user");
...
export function StudentIdCard() {
  ...
  const handleDownloadPdf = async () => {
    ...
    try {
      ...
      link.setAttribute(
        "download",
        `student-id-card-${profile?.studentId || "card"}.pdf`,
      );
  ...
  return (
    <>
      <SEO
        ...
        description="View and print your Cox's Bazar Model Polytechnic Institute digital ID card."
      />
      ...
      <div className="print:hidden space-y-8">
        ...
        <div className="flex flex-col items-center py-10">
          ...
          >
            <div
              className={`relative h-full w-full rounded-2xl shadow-xl border border-emerald-800 transition-transform duration-500 [transform-style:preserve-3d] ${isFlipped ? "[transform:rotateY(180deg)]" : ""}`}
            >
              {/* CARD FRONT */}
              <div className="absolute inset-0 flex h-full w-full flex-col overflow-hidden rounded-2xl id-card-green-bg text-white [backface-visibility:hidden]">
                ...
                <div className="id-card-banner flex items-center justify-center gap-3">
                  ...
                  <div className="text-left">
                    <h3 className="text-[11px] font-black tracking-wider text-yellow-400 uppercase">
                      COX'S BAZAR MODEL POLYTECHNIC INSTITUTE
                    </h3>
                    <p className="text-[8px] font-semibold text-emerald-300 mt-0.5">
                      Approved by BTEB & Government of Bangladesh
                    </p>
                  </div>
                </div>
                ...
                <div className="id-card-content flex flex-1 gap-4 items-center">
                  ...
                  <div className="flex-1 space-y-1.5 text-xs text-emerald-100">
                    <div>
                      <p className="text-[8px] text-emerald-400 uppercase tracking-wider font-bold">
                        Name
                      </p>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      <div>
                        ...
                        <p className="font-extrabold text-yellow-400 uppercase">
                          {profile.bloodGroup}
                        </p>
                      </div>
                    </div>
              ...
              <div className="absolute inset-0 flex h-full w-full flex-col overflow-hidden rounded-2xl id-card-green-bg text-white [backface-visibility:hidden] [transform:rotateY(180deg)]">
                ...
                <div className="id-card-banner text-center">
                  <h4 className="text-[10px] font-extrabold tracking-widest text-yellow-400 uppercase">
                    CMPI CAMPUS
                  </h4>
                </div>
                ...
                <div className="id-card-content flex flex-1 flex-col justify-between text-[9px] text-emerald-200">
                  <div className="space-y-1">
                    <p className="font-extrabold text-white text-xs uppercase tracking-wider border-b border-emerald-800 pb-1">
                      INSTRUCTIONS
                    </p>
                    <ul className="list-decimal pl-4 space-y-0.5 leading-tight text-emerald-300 font-medium">
                      <li>
                        This card is the property of Cox's Bazar Model
                        Polytechnic Institute.
                      </li>
                      <li>
                        The holder must wear and display this card visibly on
                        campus at all times.
                      </li>
                      <li>
                        If found, please return to the institute administrative
                        office.
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="flex items-end justify-between border-t border-emerald-800/80 pt-2">
                    ...
                    <div className="flex flex-col items-center gap-0.5 justify-center rounded bg-white p-1 shadow-sm border border-emerald-800">
                      ...
                      <span className="text-[6px] text-emerald-955 font-black uppercase tracking-widest flex items-center gap-0.5">
                        <ShieldCheck className="h-1.5 w-1.5 text-green-600" />{" "}
                        Verify
                      </span>
                    </div>
                    ...
                    <div className="flex flex-col items-center">
                      <div className="h-6 w-20 flex items-center justify-center opacity-90">
                        <img
                          src="/Principal_Signature_White.png"
                          alt="Signature"
                          className="h-6 object-contain"
                        />
                      </div>
                      <div className="w-24 border-t border-emerald-700 mt-1 pt-1 text-center">
                        <p className="text-[7px] font-black text-white leading-tight">
                          Ln. Md. Didar Ullah
                        </p>
                        <p className="text-[6px] text-emerald-400 leading-tight">
                          Principal
                        </p>
                      </div>
                    </div>
          ...
          <p className="mt-4 text-xs text-muted-foreground flex items-center gap-1.5 bg-muted px-3 py-1.5 rounded-full border">
            <ShieldCheck className="h-3.5 w-3.5 text-primary" /> Click on the
            card to flip it and view the back guidelines.
          </p>
        </div>
      </div>
      ...
      {typeof window !== "undefined" &&
        createPortal(
          <div
            ...
            className="hidden print:flex flex-col gap-8 items-center justify-center p-6 bg-white min-h-screen"
          >
            {/* Front Card Print */}
            <div
              id="print-card-front"
              className="print-card-box w-[480px] h-[300px] flex flex-col overflow-hidden rounded-2xl id-card-green-bg text-white relative shadow-none border border-emerald-800"
            >
              <div className="id-card-banner flex items-center justify-center gap-3">
                <img
                  src="/CMPI.png"
            ...
            >
              ...
              <div className="id-card-content flex flex-1 flex-col justify-between text-[9px] text-emerald-200">
                <div className="space-y-1">
                  ...
                  <ul className="list-decimal pl-4 space-y-0.5 leading-tight text-emerald-300 font-medium">
                    <li>
                      This card is the property of Cox's Bazar Model Polytechnic
                      Institute.
                    </li>
                    <li>
                      The holder must wear and display this card visibly on
