...
import { Home, Book, FileText, User, LogOut, Settings, Bell, Menu, X, CreditCard, ShieldCheck } from 'lucide-react';
...
const sidebarLinks = [
  ...
  { name: 'ID Card',    path: '/dashboard/id-card',  icon: ShieldCheck },
