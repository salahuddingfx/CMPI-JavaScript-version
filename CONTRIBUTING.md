# 🤝 Contributing to CMPI Client (JavaScript Version)

We are excited that you want to contribute to the **CMPI Client (JS)** project! Your support makes our software better for Cox's Bazar Model Polytechnic Institute and other schools.
