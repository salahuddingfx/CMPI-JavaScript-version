...
We take security issues extremely seriously at **CMPI Client (JS)**. We are committed to protecting user and institutional data for the **Cox's Bazar Model Polytechnic Institute** platform. This document outlines our supported versions, reporting procedures, and standard response cycles.
...
If you discover a security vulnerability within the CMPI Client (JS) project, please do **NOT** open a public issue or draft a public pull request. Doing so exposes the system to exploitation before a patch can be deployed.
...
*   **Email Subject**: `[SECURITY VULNERABILITY] CMPI Client JS Security Report`
...
If you are hosting CMPI Client (JS):
